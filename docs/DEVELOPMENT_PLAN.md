...
当前进度：Profile 可选合同、Python 规则、中文规则标签与说明已实现，旧 v2 Profile 兼容测试和
UE 5.8.1 `UE_5.8.1-v0.5.0-dev5` BuildPlugin 已通过。仍需制作真实命名/错目录 Demo 资产、重跑
宿主 Report、生成当前截图并完成录屏教程，完成前不把 M5-S2 标记为完成。
