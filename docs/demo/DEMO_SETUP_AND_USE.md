...
桌面平衡 v2 场景应显示：24 个资产完成真实采集，5 个资产通过，43 条 Issue。面板审计只处理当前选择，
...
- mobile-strict v2：111 条 Issue，8 类规则均可在同一批资产中复核；
- review-lenient v2：17 条 Issue，简单碰撞规则被关闭、Lightmap UV 要求放宽，展示同一资产在不同项目政策下结论不同。
